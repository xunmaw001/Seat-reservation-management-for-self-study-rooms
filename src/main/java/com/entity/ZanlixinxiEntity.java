...
public class ZanlixinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ZanlixinxiEntity() {
		
	}
	
	public ZanlixinxiEntity(T t) {
		try {
	 ...
	 * 设置：暂离时间
	 */
	public void setZanlishijian(Date zanlishijian) {
		this.zanlishijian = zanlishijian;
	}
	/**
	 * 获取：暂离时间
	 */
	public Date getZanlishijian() {
		return zanlishijian;
	}
	/**
	 * 设置：备注
