...
import center from '@/views/center'
    import tuizuoxinxi from '@/views/modules/tuizuoxinxi/list'
    import zuoweixinxi from '@/views/modules/zuoweixinxi/list'
    import zanlixinxi from '@/views/modules/zanlixinxi/list'
    import zuoweifenlei from '@/views/modules/zuoweifenlei/list'
...
const routes = [{
	...
	path: '/zanlixinxi',
        name: '暂离信息',
        component: zanlixinxi
      }
      ,{
	path: '/zuoweifenlei',
        name: '座位分类',
        component: zuoweifenlei
      }
      ,{
	path: '/xuesheng',
        name: '学生',
