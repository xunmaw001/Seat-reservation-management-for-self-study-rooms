  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(38, 155, 158, 1);fontSize:25px;">自习室预订座位管理注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210329/5f66cc96d34746338ac25d4d607fd3d9.jpg");
		height: 100vh;
