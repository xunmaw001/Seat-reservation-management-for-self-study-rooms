<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="座位分类" prop="zuoweifenlei">
          <el-select v-model="ruleForm.zuoweifenlei" placeholder="请选择座位分类">
            <el-option
                v-for="(item,index) in zuoweifenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
