<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="座位分类" prop="zuoweifenlei">
          <el-input v-model="ruleForm.zuoweifenlei" 
              placeholder="座位分类" clearable  :readonly="ro.zuoweifenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="座位分类" prop="zuoweifenlei">
              <el-input v-model="ruleForm.zuoweifenlei" 
                placeholder="座位分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退座时间" prop="tuizuoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tuizuoshijian" 
                type="datetime"
                placeholder="退座时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuizuoshijian" label="退座时间" prop="tuizuoshijian">
              <el-input v-model="ruleForm.tuizuoshijian" 
                placeholder="退座时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.tuizuoshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoweibianhao = true;
          ...
          if(o=='zuoweifenlei'){
            this.ruleForm.zuoweifenlei = obj[o];
	    this.ro.zuoweifenlei = true;
            continue;
          }
          if(o=='xuejihao'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='tuizuoshijian'){
            this.ruleForm.tuizuoshijian = obj[o];
	    this.ro.tuizuoshijian = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssm12q44/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tuizuoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuizuoxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
